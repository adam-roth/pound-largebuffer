...
main(const int argc, char **argv)
{
    ...
    char                tmp[MAXBUF];	//aroth:  use of MAXBUF is okay here (but profoundly silly as we'll never need 4K+ of data to store an IP address); we are storing an IP address
#ifndef SOL_TCP
    struct protoent     *pe;
#endif
